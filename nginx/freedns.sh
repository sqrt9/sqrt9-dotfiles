################################################################################
# This is a crontab example for cblt.3runebla.de - (uid: badnewsbear951)
# Generated 2026-04-17 01:17:05 PST @ https://freedns.afraid.org/
################################################################################
# NOTES:
...
# 3) To verify updates are occuring, wait 5 minutes, then 'cat /tmp/freedns_cblt_3runebla_de.log'
...
# 
# Example #1:
# wget --no-check-certificate -O - https://freedns.afraid.org/dynamic/update.php?
# 
# Example #2:
# curl https://freedns.afraid.org/dynamic/update.php?
# 
# Example #3:
# fetch -o - https://freedns.afraid.org/dynamic/update.php

# You might need to include this path line in crontab, (or specify full paths)
PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
4,9,14,19,24,29,34,39,44,49,54,59 * * * * sleep 35 ; wget --no-check-certificate -O - https://freedns.afraid.org/dynamic/update.php?$(cat /Users/hpt/docs/software/dotfiles/nginx/HASH) >> freedns_cblt_3runebla_de.log 2>&1 &